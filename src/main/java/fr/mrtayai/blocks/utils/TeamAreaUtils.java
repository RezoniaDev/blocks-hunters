...
public class TeamAreaUtils {
    ...
    public TeamAreaUtils( World world, int x, int y, int z, UUID teamID, Game game){
        Location loc1 = new Location(world, x, y, z);
        Location loc2 = new Location(world, x + 12, y + 6 , z + 19);
        this.area = new Area(loc1, loc2);
        this.base = new Base(x, y, z, world, game.getMain().getConfig().getBoolean("enchanting_table"));
